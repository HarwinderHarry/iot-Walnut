                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className='search-adminBox flex items-center justify-between w-32rem]'>
                        ...
                        <div className='adminBtn flex'>
                            {/* First Button */}
                            <div>
                                <button className="btn btn-neutral font-bold py-2 px-4 rounded-[10px] flex items-center justify-between text-[14px] mr-4" onClick={() => document.getElementById('my_modal_adduser').showModal()}>Add Users <FaPlus className='pl-2 text-[24px]' /></button>
                                <dialog id="my_modal_adduser" className="modal">
                                            ...
                                            <div className="mt-3 w-3/4">
                                                <form onSubmit={formik.handleSubmit}>
                                                    ...
                                                    <div className="mt-6">
                                                        <button
                                                            type="submit"
                                                            className="btn text-white gap-2 btn-neutral btn-block rounded text-[17px] font-[500] landing-[19px]" onClick={() => document.getElementById('my_modal_fleetuserVertification').showModal()}
                                                        >
                                                            Submit
                                                        </button>
                                                        <dialog id="my_modal_fleetuseradminVertification" className="modal">
                            ...
                            <table className="table">
                                ...
                                <tbody className='mt-3'>
                                    ...
                                    <tr className='shadow-[0_3.5px_5.5px_0_#00000005] mb-3 h-20'>
                                        <th className='shadow-none cursor-pointer' onClick={()=>navigate('/userfleets')}>
                                            <label>
                                                <input type="checkbox" className="checkbox" />
                                            </label>
                                        </th>
                                    
                                        <td className='bg-base-100 rounded-l-[15px] cursor-pointer' onClick={()=>navigate('/userfleets')}>
                                            <div className="flex items-center gap-3">
                                                    <div className="font-bold text-base-500 font-[900] text-[19px] landing-[35px]">Vicken</div>
                                            </div>
                                        </td>
                                        <td className='text-[16px] font-[500] landing-[35px] bg-base-100 cursor-pointer' onClick={()=>navigate('/userfleets')}>
                                        Amol Bhardwaj
                                        </td>
                                        <td className='text-[16px] font-[500] landing-[35px] bg-base-100 cursor-pointer' onClick={()=>navigate('/userfleets')}>
                                            5
